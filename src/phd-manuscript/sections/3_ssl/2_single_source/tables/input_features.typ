...
#figure(
  table(
    ...
    toprule,
    table.header(
      [], [\#channels], [\#epochs], [#mae-theta-header],
      //[#mae-dist-header],
    ),
    ...
    dashedrule, [#acr("ILD") only], [1], [100],
    [38.27], [#acr("IPD") only], [1], [100],
    [22.74], [#acr("STFT") magnitude only], [2], [100],
    [31.17], [#acr("STFT") phase only], [2], [100],
    [27.97],
