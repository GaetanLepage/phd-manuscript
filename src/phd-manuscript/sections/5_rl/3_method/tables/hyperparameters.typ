...
#figure(
  table(
    ...
    [#env-horizon-value],
    [#n-source-pos],
    [Number of possible source positions],
    [#n-source-pos-value],
    ...
    [$lambda_"GAE"$],
    [Bias–variance trade-off parameter for the #acr("GAE")],
    [0.95],
    [#ppo-loss-epsilon],
    [Clipping threshold for the clipped loss #_ppo-clipped-loss],
    [0.2],
    [#ppo-value-loss-epsilon],
    [Clipping threshold for the clipped value loss #ppo-value-loss-clipped],
    [0.1],
    ...
    [mini-batch size],
    [Number of samples (transitions) in each mini-batch],
    [500],
