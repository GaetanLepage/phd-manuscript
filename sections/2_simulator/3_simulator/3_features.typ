...
This process suits use cases where each _step_ is independent of the others.
...
Consequently, as presented in @sec:simulator:reverb:background:reverb, the early part of the received audio correspond to the direct path the source signal uses, and the reverberation's effect remains invisible.
