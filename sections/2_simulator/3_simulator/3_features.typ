...
*Continuous sources.*
To allow for more realistic modelling, we introduce continuous speech sources.
...
Ultimately, the simulator is capable of modelling dynamic interaction scenarios leveraging a static #acr("RIR") simulation library.
Thanks to our bootstrapping technic for reverberation, one may employ short simulation steps between which all objects in the room can be moved freely.
