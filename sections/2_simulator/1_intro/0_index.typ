...
The significant costs of gathering and labeling datasets also limit applications of supervised learning.
Synthetic datasets can be generated by simulators that also offer automatic sample labeling.
The Kubric @greff_kubric_2022 dataset generator leverages the _PyBullet_ @noauthor_bulletphysicsbullet3_2024 simulator and allows for the synthesizing of massive amounts of photorealistic data.

*Human Robot interactions.*
In order for people to check


*Sim2Real challenges.*
Despite offering consequent 

*Acoustic simulation.*
Vision is the dominant modality used for robotic perception in practical applications.
Nonetheless, different cues have also been used in Robotics (LIDAR #todo, haptic feedback #todo, audio #todo, etc.).
In this thesis, the focus will be on acoustic applications in robotics.
Simulators

Robotics problem are not limited to mechanical sensing and act

In conclusion, simulation is a key component in most of the app
