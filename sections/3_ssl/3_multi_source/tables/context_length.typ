...
#figure(
  table(
    ...
    table.header(
      table.cell(colspan: 3, align: center)[*Settings*],
      table.cell(colspan: 5, align: center)[*Metrics*],
    ),
    ...
    table.cell(rowspan: 2)[*4*  (64ms) ], [4], [1], [], [21.28], [50.73], [68.83], [49.37],
    [2], [2], [], [24.51], [47.34], [68.87], [46.47],
    midrule,

    table.cell(rowspan: 3)[*8*  (149ms)], [8], [1], [], [12.84], [62.05], [75.33], [61.18],
    [4], [2], [], [15.13], [58.76], [75.10], [57.21],
    [2], [4], [], [19.76], [54.40], [76.18], [52.95],
    midrule,

    table.cell(rowspan: 4)[*16* (320ms)], [16], [1], [], [8.71], [72.99], [83.35], [71.73],
  ...
  kind: table,
  caption: [
    SSL performance depending on the input duration.
  ],
)
