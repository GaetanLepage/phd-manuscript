...
#draft[
  ...
  In general the proposed approach breaks the #acr("ASSL") task in several steps for which an specific solution is presented.
  ...
  One could envisage directly learning to predict the sources positions from a batch of shifted #acr("DoA") maps.
  ...
  Both of those tracks might allow to push detection performance by eliminating hand-crafting middle-steps.
  ...
  Indeed, most social robots incorporates both audio and vision sensors to allow for broader perceptual capabilities.
